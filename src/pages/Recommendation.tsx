...
const Recommendation = () => {
  ...
  const [searchType, setSearchType] = useState<"company" | "industry" | "ksic">(
    "company"
  );
  const [recommendations, setRecommendations] = useState<IndustrialComplex[]>(
    []
  );
  ...
  const handleSearch = () => {
    ...
    const scored = mockIndustrialComplexes
      .map((complex) => ({
        ...complex,
      ...
      .sort(
        (a, b) =>
          b.suitabilityScore +
          b.policyImpact -
          (a.suitabilityScore + a.policyImpact)
      );
            ...
            <div className="space-y-4">
              <div className="flex space-x-2 mb-4">
                {[
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setSearchType(type.key as "company" | "industry" | "ksic")
                    }
                  >
                    {type.label}
                  </Button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Select
                  ...
                  onValueChange={setPolicyScenario}
                >
                  <SelectTrigger>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                <Badge variant="outline">
                  {recommendations.length}개 산업단지 분석
                </Badge>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        {index === 0 && (
                          <Badge className="bg-blue-600">최적 추천</Badge>
                        )}
                        <div className="flex items-center">
                          <Star className="w-4 h-4 text-yellow-400 fill-current" />
                          <span className="text-sm font-medium ml-1">
                            {(
                              complex.suitabilityScore + complex.policyImpact
                            ).toFixed(1)}
                          </span>
                          {complex.policyImpact !== 0 && (
                            ...
                            >
                              ({complex.policyImpact > 0 ? "+" : ""}
                              {complex.policyImpact.toFixed(1)})
                            </span>
                          )}
                        </div>
                      </div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <div>
                                ...
                                <p className="text-sm font-medium">
                                  {complex.employmentCount.toLocaleString()}명
                                </p>
                              </div>
                            </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        평균 적합도 점수 +
                        {(Math.random() * 1.5 + 0.5).toFixed(1)}점 상승
                      </p>
                    </div>
                    <div>
                      <h4 className="text-sm font-medium text-gray-700 mb-1">
                      ...
                      <p className="text-sm text-gray-600">
                        정책 시행 비용 {(Math.random() * 500 + 200).toFixed(0)}
                        억원
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {Math.floor(Math.random() * 3 + 2)}년 소요 예상
                      </p>
                    </div>
                  </div>
                </CardContent>
